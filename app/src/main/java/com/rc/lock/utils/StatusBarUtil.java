...
public class StatusBarUtil {
    ...
    /**
     *
     * @param activity needs to be set
     */
     ...
     * CoordinatorLayout
     *
     * It is suitable for the interface where the picture is used as the background. At this time, the picture needs to be filled into the status bar.
     *
     * @param activity
     * @param statusBarAlpha
     */
